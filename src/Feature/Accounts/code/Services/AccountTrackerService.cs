...
namespace Sitecore.Demo.Platform.Feature.Accounts.Services
{
    ...
    public class AccountTrackerService : IAccountTrackerService
    {
        ...
        public static Guid LoginGoalId => Guid.Parse(Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.LoginGoalId", "{66722F52-2D13-4DCC-90FC-EA7117CF2298}"));
        public static Guid RegistrationGoalId => Guid.Parse(Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.RegistrationGoalId", "{8FFB183B-DA1A-4C74-8F3A-9729E9FCFF6A}"));
        public static Guid ExportDataGoalId => Guid.Parse(Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.ExportDataGoalId", "{D0EF461C-3AA0-40B8-9B5F-C1723E54F6ED}"));
        public static Guid DeleteProfileGoalId => Guid.Parse(Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.DeleteProfileGoalId", "{83A9DF9A-D7D9-4B73-BAE0-4F77B4935462}"));
