...
namespace Sitecore.Demo.Platform.Feature.Accounts.Infrastructure.Pipelines.IdentityProviders
{        
    public class MicrosoftAccount : IdentityProvidersProcessor
    {
        ...
        {      
            ...
            string clientSecret = Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.Microsoft.ClientSecret");     //todo: move this to site-specific configuration item   
            string clientId = Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.Microsoft.ClientId"); //todo: move this to site-specific configuration item        
