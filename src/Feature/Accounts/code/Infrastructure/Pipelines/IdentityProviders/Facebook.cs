...
namespace Sitecore.Demo.Platform.Feature.Accounts.Infrastructure.Pipelines.IdentityProviders
{
    public class Facebook : IdentityProvidersProcessor
    {
        ...
        protected override void ProcessCore([NotNull] IdentityProvidersArgs args)
        {
            ...
            string appId = Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.Facebook.AppId");   //todo: move this to site-specific configuration item
            string appSecret = Settings.GetSetting("Sitecore.Demo.Platform.Feature.Accounts.Facebook.AppSecret");  //todo: move this to site-specific configuration item
