...
module.exports = {
    ...
    sass: {
        root: '/sass/**/*.scss',
        components: {
            sassPath: '../Lighthouse/sass/*.scss',
            stylePath: 'styles'
        },
        styles: {
            sassPath: ['../Lighthouse/sass/styles/common/*.scss',
                '../Lighthouse/sass/styles/content-alignment/*.scss',
                '../Lighthouse/sass/styles/layout/*.scss'
            ],
            stylePath: 'styles',
            concatName: 'styles.css'
        },
        dependency: {
            sassPath: ['../Lighthouse/sass/styles/**/*.scss'],
        ...
        core: {
            sassPath: ['../Lighthouse/sass/abstracts/**/*.scss',
                '../Lighthouse/sass/base/**/*.scss',
                '../Lighthouse/sass/components/**/*.scss', 'sass/abstracts/**/*.scss'
            ],
            stylePath: 'styles'
        },
        disableSourceUploading: true
