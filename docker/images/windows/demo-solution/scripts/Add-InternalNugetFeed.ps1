...
if (-not ([string]::IsNullOrEmpty($env:INTERNAL_NUGET_SOURCE) -and [string]::IsNullOrEmpty($env:INTERNAL_NUGET_SOURCE_USERNAME) -and [string]::IsNullOrEmpty($env:INTERNAL_NUGET_SOURCE_PASSWORD))) {
